...
for (const [i, n] of [3, 7, 9].entries())
  mc(`math-g1-num-r0${i + 1}`, 1, 1, {
    title: "מָצְאוּ אֶת הַמִּסְפָּר", prompt: `מָצְאוּ אֶת הַמִּסְפָּר ${n}`,
...
mc("math-g3-round-r01", 3, 3, { title: "עִגּוּל לַעֲשָׂרֶת", prompt: "לְאֵיזוֹ עֲשָׂרֶת הֲכִי קָרוֹב הַמִּסְפָּר?", glyph: "47", correct: 50, distractors: [40, 60, 45] });
...
mc("math-g4-place-r01", 4, 3, { title: "עֵרֶךְ הַסִּפְרָה", prompt: "מָה עֵרֶךְ הַסִּפְרָה הַמֻּדְגֶּשֶׁת?", glyph: "3 5 2 (מֵאוֹת)", correct: 300, distractors: [3, 30, 3000] });
mc("math-g4-round-r01", 4, 3, { title: "עִגּוּל לַמֵּאָה", prompt: "לְאֵיזוֹ מֵאָה הֲכִי קָרוֹב הַמִּסְפָּר?", glyph: "278", correct: 300, distractors: [200, 280, 270] });
mc("math-g4-round-r02", 4, 3, { title: "אֹמֶד", prompt: "מָה הָאֹמֶד הֲכִי קָרוֹב?", glyph: "39 + 41", correct: 80, distractors: [70, 90, 100] });
